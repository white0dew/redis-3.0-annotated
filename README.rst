Redis 3.0 源码注释（增注）——white0dew
原始代码来自： https://github.com/antirez/redis 。
黄老师的《Redis 设计与实现》 <http://RedisBook.com>`_\ 正在各大网店发售中，
希望大家可以多多支持这本书。

本项目是在阅读黄健宏老师的《Redis 设计与实现》期间使用的注释版Redis代码
其中的大部分注释来自黄老师，我在阅读期间删除、修改、增加了一些影响源码阅读的注释，使得
代码的阅读更容易理解，希望能够帮助Redis源码初学者。
...
四、 阅读数据库相关代码
五、 阅读客户端和服务器相关代码
六、 阅读多机（Cluster）的实现代码
参考：
[@codelearning](https://blog.huangz.me/diary/2014/how-to-read-redis-source-code.html
)
附录：各个源码文件的作用简介
------------------------------
